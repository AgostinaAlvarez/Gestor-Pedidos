...
export default function Medios({setTotal}) {
  
  const {totalMontos,setTotalMontos} = useContext(AppContext)
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.item}>
        ...
        style={styles.inputt} placeholder='$' keyboardType='numeric'/>
      </View>
      <Text>Efectivo</Text>
      <View style={styles.item}>
